...
gad = User.create!(email: "gad@email.com", password: "123456", city: "Montreal")
...
karine = User.create!(email: "karine@email.com", password: "123456", city: "Toronto")
...
pascal = User.create!(email: "pascal@email.com", password: "123456", city: "Ottawa")
