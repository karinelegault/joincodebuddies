...
project1 = Project.create!(user_id: "#{rand(1..3)}", name: "Notes inc", description: "I would like to create a software to take notes during meeting. The idea would be the have visual elements to make it visible at all time.", chatroom_link: "www.google.com", teammates: [2,3] )
...
project2 = Project.create!(user_id: "#{rand(1..3)}", name: "Formation hub for designers", description: "The idea would be to create a hub in order to display formation available for designer towards different rooms.", chatroom_link: "www.google.com", teammates: [2,3] )
...
project3 = Project.create!(user_id: "#{rand(1..3)}", name: "Devices tester", description: "I would like to create an amazing software to help QA experts testing products on as many devices at the same time.", chatroom_link: "www.google.com", teammates: [1,2] )
...
project4 = Project.create!(user_id: "#{rand(1..3)}", name: "Masks finder", description: "Create a software to help health workers find masks supplies easier.", chatroom_link: "www.google.com", teammates: [1,2] )
